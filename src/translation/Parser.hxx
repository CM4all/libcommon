...
private:
	...
	void HandleMountTmpTmpfsExec(std::string_view payload);
	...
	void HandleMaxInotify(std::span<const std::byte> payload);
	...
	void HandleProcessName(std::string_view payload);
#endif // TRANSLATION_ENABLE_SPAWN
