...
TEST(TestSHA3_256, Empty)
{
	...
	EXPECT_EQ(hash, "a7ffc6f8bf1ed76651c14756a061d662f580ff4de43b49fa82d80a4b80f8434a"sv);
}
...
TEST(TestSHA3_256, FoxDog)
{
	...
	const auto digest = ctx.Digest();
	const auto hash = HexFormat(std::span{digest});
	EXPECT_EQ(hash, "69070dda01975c8c120c3aada1b282394e7f032fa9cf32f4cb2259a0897dfc04"sv);
}
